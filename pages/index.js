              ...
              <div className="col-lg-8">
                <div className="hero-content">
                  ...
                  <h3 className="wow fadeInDown" wow-data-delay="50ms">
                    Goresy ile her yerden randevu alın
                  </h3>
                  <div
                  ...
                  <p className="tags">
                    <span>Popular:</span>
                    <a href="#">Kişisel Bakım</a>, <a href="#">Restoran</a>, 
                    <a href="#">Otomotiv</a>, <a href="#">Spor</a>, 
                    <a href="#">Sağlık</a>, <a href="#">Moda</a>, 
                    <a href="#">Eğitim</a>, <a href="#">Hukuk</a>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-2 col-md-4 category-column">
                <div className="category-item category-item-one">
                  <div className="info text-center">
                    <div className="icon">
                      <i className="flaticon-balloons"></i>
                    </div>
                    <h6>Kişisel Bakım</h6>
                  </div>
                  <Link href="/">

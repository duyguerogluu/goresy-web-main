              ...
              <div className="sidebar-widget-area">
                <div className="widget search-listing-widget mb-30 wow fadeInUp">
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    <div className="search-form">
                      ...
                      <div className="form_group">
                        <select className="wide">
                          ...
                          <option value={'personal_care'}>Kişisel Bakım</option>
                          <option value={'food'}>Yiyecek</option>
                          <option value={'automotive'}>Otomotiv</option>
                          <option value={'health'}>Sağlık</option>
                          <option value={'fashion'}>Moda</option>
                          <option value={'sport_entertainment'}>Spor ve Eğlence</option>
                          <option value={'education_other'}>Eğitim ve Diğer</option>
                          <option value={'law_property'}>Hukuk</option>
                    ...
                    <div className="price-range-widget">
                      <h4 className="widget-title">Yaklaşık Uzaklık: 50 km</h4>
                ...
                <div className="widget newsletter-widget mb-30 wow fadeInUp">
                  ...
                  >
                    ...
                    <h3>E-posta listemize abone olun</h3>
                    <button className="main-btn icon-btn">Abonel Ol</button>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="filter-left d-flex align-items-center">
                      ...
                      <div className="sorting-dropdown">
                        <select className="wide">
                          ...
                          <option value={2}>Price Order</option>
